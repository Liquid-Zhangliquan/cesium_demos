...
export class CustomeFreezeRiver extends React.Component {
    static title: string = "结冰河流"
        ...
        Axios.get("./static/json/islandRiver.json").then((res) => {
            ...
            var River_Material = new Cesium.Material({
                fabric: {
                    ...
                    //     normalMap: './static/images/ice1.jpg',
                    //     frequency: 500.0,
                    //     animationSpeed: 0.01,
                    //     amplitude: 10.0
                    // }
    ...
    render() {
        return (
            <CesiumMap id={CustomeFreezeRiver.title} onViewerLoaded={(viewer) => { this.handleViewerLoaded(viewer) }} />
        )
    }
